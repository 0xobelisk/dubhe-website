	...
	return (
		...
		>
			<div className="bg-[#453a6e] w-full h-full flex items-center justify-center px-6 py-3 rounded-full">
				<span
					className="text-[#f4d76c] font-bold text-2xl tracking-wide whitespace-nowrap"
...
const projects: Project[] = [
	{
		...
		title: 'Merak',
		description:
			'Merak is a privacy-preserving DeFi liquidity hub built on dubhe engine.',
		category: 'Defi',
	...
	},
	{
		...
		title: 'Numeron',
		description:
			'A fantasy adventure game with stunning visual effects and refined combat mechanics.',
		category: 'Gaming',
		...
		<div className="py-24 sm:py-32 relative overflow-hidden">
			...
			<div className="mx-auto max-w-[1200px] px-6 lg:px-8">
				<div className="mx-auto max-w-2xl lg:mx-0">
					<h2 className="text-base font-semibold leading-7 text-blue-400 mb-3">
						FEATURED PROJECTS
					</h2>
					...
					<p className="mt-6 text-xl leading-8 text-gray-300">
						From indie gems to top-tier productions, explore the
						amazing games created by developers around the world
						using Dubhe Engine.
					</p>
				</div>

				<div
					className={`mx-auto mt-16 gap-x-8 gap-y-20 lg:mx-0 lg:max-w-none transition-opacity duration-700 ${isLoaded ? 'opacity-100' : 'opacity-0'}`}
				>
							...
							<div className="mb-4 flex items-center justify-between">
								...
								<div className="flex space-x-3">
									<Button
										...
										size="icon"
										onClick={prevProject}
										className="rounded-full bg-black/50 backdrop-blur-sm border-gray-700/30 hover:bg-black/70 hover:border-blue-500/50"
									>
								...
								<div className="absolute bottom-0 left-0 right-0 p-8 transform transition-transform duration-500 group-hover:translate-y-0 translate-y-0">
									<div className="flex flex-col">
										<div className="flex justify-between items-start">
											<div>
												<h3 className="text-2xl font-bold text-white sm:text-3xl mb-1">
													{activeProject.title}
												</h3>
												<p className="text-sm text-gray-400 mb-4">
													By {activeProject.studio}
												</p>
											</div>
									...
									{projects.map((project, index) => (
										...
										>
											...
											<div className="min-w-0 flex-auto">
												<p
													className={`text-sm font-medium leading-6 ${index === activeIndex ? 'text-blue-400' : 'text-white'}`}
												>
													{project.title}
												</p>
