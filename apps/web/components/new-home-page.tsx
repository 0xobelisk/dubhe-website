      ...
      <div className="py-24 px-6 lg:px-8 bg-gradient-to-br from-slate-900 via-purple-900 to-blue-900 relative overflow-hidden">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 lg:gap-4">
            ...
            >
              {/* Step Number */}
              <div className="text-white text-2xl font-bold mb-8">1</div>
              
              {/* Card */}
              <div className="bg-gray-900/80 backdrop-blur-sm rounded-2xl p-8 border border-gray-700 min-h-[400px] flex flex-col">
            ...
            >
              {/* Step Number */}
              <div className="text-white text-2xl font-bold mb-8">2</div>
            ...
            >
              {/* Step Number */}
              <div className="text-white text-2xl font-bold mb-8">3</div>
            ...
            >
              {/* Step Number */}
              <div className="text-white text-2xl font-bold mb-8">4</div>
